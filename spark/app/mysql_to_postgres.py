...
if __name__ == '__main__':
      ...
      spark = SparkSession \
            .builder \
            .config("spark.jars", "C:/Users/agung/Documents/DE - Digital Skola/digital_skola/projects/Digital-Skola-Final-Project/spark/resources/mysql-connector-java-8.0.30.jar") \
            .master("local") \
      ...
      spark = SparkSession \
            .builder \
            .config("spark.jars", "C:/Users/agung/Documents/DE - Digital Skola/digital_skola/projects/Digital-Skola-Final-Project/spark/resources/postgresql-42.2.25.jar") \
            .master("local") \
            .appName("ds9_final_project") \
            .getOrCreate()
      ...
      application_train.write.format('jdbc').options(
            url='jdbc:postgresql://host.docker.internal:3306/postgres',
